...
struct qt_meta_stringdata_CLASSAgentENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSAgentENDCLASS = QtMocHelpers::stringData(
    "Agent"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSAgentENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject Agent::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSAgentENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSAgentENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSAgentENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *Agent::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSAgentENDCLASS.stringdata0))
